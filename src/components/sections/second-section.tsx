  ...
  return (
    ...
    >
      ...
      <div className="content-container">
        <span className="font-arimo uppercase text-lg md:text-2xl tracking-tight">
          empower your team . impress your audience
        </span>

        <p className="mt-[var(--editorial-space)] text-[clamp(1.5rem,3.5vw,4.5rem)] leading-[1.1] tracking-tight font-arimo">
          This is a time of rebirth for collective film culture.
        </p>
        <p className="max-w-[42ch] text-[clamp(1.5rem,3.5vw,4.5rem)] leading-[1.1] tracking-tight opacity-50 font-arimo">
          {/*<br />*/}
          We empower the cinema teams leading this movement with a modern
          point-of-sale system designed for ease and versatility.
        </p>

        <p className="mt-[var(--editorial-space)] font-arimo uppercase text-lg md:text-2xl tracking-tight">
      ...
      {/*first three images*/}
      <div className="flex justify-between mt-[var(--editorial-space)] pr-2 md:pr-6 lg:pr-12">
      ...
      <div
        ref={containerRef}
        className="mt-[var(--section-space)] flex justify-center shrink-0 flex-nowrap"
      >
        <div className="hidden lg:block w-[35vw] pt-44 overflow-hidden shrink-0">
          <img
        ...
        <div
          ref={middleImageRef}
          className="min-h-[max(42rem,100svh)] w-full lg:min-h-[max(48rem,130svh)] lg:w-[30vw] overflow-hidden lg:rounded-lg shrink-0 relative image-div"
        >
          <img
          ...
          <div className="absolute bottom-12 z-10 text-white left-1/2 -translate-x-1/2 w-full max-w-4xl page-gutter [container-type:inline-size]">
            <h2
              className="text-center
              text-[clamp(2rem,14cqi,5rem)]
        ...
        <div className="w-[35vw] shrink-0 hidden lg:flex justify-end">
          <img
